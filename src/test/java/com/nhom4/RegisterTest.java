...
//    }
    ...
    public Object[][] RegisterData() {
        return new Object[][]{
                {"", "invalidemail", "123456789", "username", "password", "mismatch", "Thông tin không hợp lệ"}, // Invalid email format
                {"Trần Thị Như Ý", "tranthinhuy@gmail.com", "123456789", "existingUser", "password", "password", "Tài khoản đã tồn tại"}, // Username exists
                {"Trần Thị Như Ý", "validemail@gmail.com", "123456789", "newUser", "password", "mismatch", "Mật khẩu không khớp"} // Password mismatch
        };
    }
